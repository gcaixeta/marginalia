...
func newTestBrowseModel() BrowsePickerModel {
...
func TestBrowsePickerInitialMode(t *testing.T) {
	m := newTestBrowseModel()
	if m.filterMode {
		t.Error("Expected filterMode to be false on init")
	}
}

func TestBrowsePickerEnterFilterMode(t *testing.T) {
	m := newTestBrowseModel()

	msg := tea.KeyMsg{Type: tea.KeyRunes, Runes: []rune{'/'}}
	updated, _ := m.Update(msg)
	m = updated.(BrowsePickerModel)
...
func TestBrowsePickerCharInNavMode(t *testing.T) {
	m := newTestBrowseModel()
...
func TestBrowsePickerCharInFilterMode(t *testing.T) {
	m := newTestBrowseModel()
	m.filterMode = true
...
func TestBrowsePickerEscExitsFilter(t *testing.T) {
	m := newTestBrowseModel()
	m.filterMode = true
	m.input = "hello"
...
func TestBrowsePickerEnterSelectsInFilterMode(t *testing.T) {
	m := newTestBrowseModel()
	m.filterMode = true
...
func TestBrowsePickerViewShowsMode(t *testing.T) {
	m := newTestBrowseModel()
